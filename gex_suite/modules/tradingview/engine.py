...
class BatchOptions:
    ...
    # Quote source for TO FUTURE auto-fill (ES1!/NQ1!/RTY1! ratio/offset).
    # "yfinance" (default) | "tv_legend" (reserved, not yet implemented).
    futures_quote_source: str = "yfinance"
